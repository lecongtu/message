...
class NewConversationViewController: UIViewController {
    ...
    private let noResultTable: UILabel = {
        let label = UILabel()
        label.isHidden = true
    ...
    override func viewDidLayoutSubviews() {
        ...
        noResultTable.frame = CGRect(x: view.width/4,
                                 y: (view.height-200)/2,
                                 width: view.width/2,
                                 height: 200)
    }
...
extension NewConversationViewController: UISearchBarDelegate{
    ...
    func updateUI(){
        if results.isEmpty {
            self.noResultTable.isHidden = false
            self.tableView.isHidden = true
        }else{
            self.noResultTable.isHidden = true
